...
- `/home/agent/projects/outpost_pi/AGENTS.md` and subproject `CLAUDE.md` files — current Outpost-Pi guidance is useful but mostly persona/orchestration prose, not API-reference substrate.
