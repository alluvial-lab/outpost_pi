...
- Contradicting source: `b7a452f1`; `app/lib/data/transport/connection_manager.dart:837-920`
...
## Contradiction
Commit `b7a452f1` shipped the auth-read hedge and atomic loser-close fix in this release. The entry describes a current known defect and a scoped fix even though the implementation now cancels and awaits superseded attempts before adopting a channel.
