...
**Verification run**:
- `cd /home/agent/forks/remote_pi && git show --stat --find-renames --find-copies 95b4f94d && git show --no-ext-diff --no-color --find-renames --find-copies 95b4f94d -- cockpit/lib/app/settings/ui/categories/connectivity_settings_panel.dart cockpit/lib/app/settings/ui/settings_page.dart cockpit/test/settings/connectivity_settings_panel_test.dart .work/active/stories/epic-bold-cockpit-workspace-projection-settings-split-step-3.md`: reviewed commit `95b4f94d` diff.
