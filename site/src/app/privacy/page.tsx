...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Outpost-Pi — what little data we touch, why we touch it, and your LGPD rights.",
};
  ...
  return (
    ...
    >
      <LegalSection id="who" number={1} title="Who We Are (Data Controller)">
        <p>
          Outpost-Pi is operated by Flutterando Desenvolvimento de Programas de
      ...
      <LegalSection id="collect" number={2} title="Data We Collect">
        ...
        <p>
          Outpost-Pi is designed so that you provide essentially nothing to us on
