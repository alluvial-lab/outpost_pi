...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Outpost-Pi — provided by Flutterando Desenvolvimento de Programas de Computador LTDA.",
};
  ...
  return (
    ...
    >
      <LegalSection id="acceptance" number={1} title="Acceptance of Terms">
        <p>
          By installing, accessing, or using the Outpost-Pi mobile application,
          the Outpost-Pi Pi-side extension, the Outpost-Pi relay service, or any
          other software or service provided under the Outpost-Pi name
      ...
      <LegalSection id="account-pairing" number={2} title="Account & Pairing">
        <p>
          Outpost-Pi does not require you to create an account, register an email
      ...
      >
        <p>
          Outpost-Pi does not host or moderate user-to-user content (the relay is
      ...
      >
        <p>
          The source code for Outpost-Pi components is released under the MIT
        ...
        <p>
          The Outpost-Pi name, logo, and visual identity (including the π symbol
