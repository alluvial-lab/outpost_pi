...
/// aparelhos pareados.
///
/// Tudo é delegado ao binário `outpost-pi` (shell-out) e ao config compartilhado
...
/// mora em `data/`.
///
/// Escopo: relay global + listar aparelhos (via CLI `outpost-pi`). Revogar e
...
abstract class RelayGateway {
  ...
  /// Define a URL do relay global (`outpost-pi set-relay <url>`).
  Future<Result<void, RelayError>> setRelay(String url);

  /// Lista os aparelhos pareados (`outpost-pi devices`).
