...
/// Load the cross-surface color contract for app-side theme tests.
...
/// Map the app's direct native palette ports to shared contract roles.
Map<String, Color> appContractRoles(AppColors colors) => <String, Color>{
  'bgPrimary': colors.bg,
  'bgSecondary': colors.surface,
  'bgTertiary': colors.border,
