...
sealed class ClientMessage {
  ...
  static ClientMessage fromJson(Map<String, dynamic> json) {
    ...
    return switch (type) {
      ...
      'capture_upload_begin' => CaptureUploadBegin.fromJson(json),
      'capture_upload_chunk' => CaptureUploadChunk.fromJson(json),
      'capture_upload_end' => CaptureUploadEnd.fromJson(json),
...
final class CaptureUploadBegin extends ClientMessage {
  const CaptureUploadBegin({required this.id, required this.sessionId, required this.uploadId, required this.deviceLabel, required this.totalBytes, required this.captureKind});

  @override
  String get type => 'capture_upload_begin';
  ...
  factory CaptureUploadBegin.fromJson(Map<String, dynamic> json) => CaptureUploadBegin(
        id: json['id'] as String,
        sessionId: json['session_id'] as String,
...
final class CaptureUploadChunk extends ClientMessage {
  const CaptureUploadChunk({required this.id, required this.sessionId, required this.uploadId, required this.sequence, required this.payload});

  @override
  String get type => 'capture_upload_chunk';
  ...
  factory CaptureUploadChunk.fromJson(Map<String, dynamic> json) => CaptureUploadChunk(
        id: json['id'] as String,
        sessionId: json['session_id'] as String,
        uploadId: json['upload_id'] as String,
...
final class CaptureUploadEnd extends ClientMessage {
  const CaptureUploadEnd({required this.id, required this.sessionId, required this.uploadId, required this.sha256});

  @override
  String get type => 'capture_upload_end';
  ...
  factory CaptureUploadEnd.fromJson(Map<String, dynamic> json) => CaptureUploadEnd(
        id: json['id'] as String,
        sessionId: json['session_id'] as String,
        uploadId: json['upload_id'] as String,
...
final class CaptureUploadAck extends ServerMessage {
  ...
  @override
  String get type => 'capture_upload_ack';
  ...
  factory CaptureUploadAck.fromJson(Map<String, dynamic> json) => CaptureUploadAck(
        sessionId: json['session_id'] as String,
        inReplyTo: json['in_reply_to'] as String,
        uploadId: json['upload_id'] as String,
        stage: json['stage'] as String,
        nextSequence: (json['next_sequence'] as num?)?.toInt(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        'upload_id': uploadId,
        'stage': stage,
        if (nextSequence case final nextSequence?)
...
final class CaptureUploadError extends ServerMessage {
  const CaptureUploadError({required this.sessionId, required this.inReplyTo, required this.uploadId, required this.code, required this.message});

  @override
  String get type => 'capture_upload_error';
  ...
  factory CaptureUploadError.fromJson(Map<String, dynamic> json) => CaptureUploadError(
        sessionId: json['session_id'] as String,
        inReplyTo: json['in_reply_to'] as String,
        uploadId: json['upload_id'] as String,
        code: json['code'] as String,
...
String? sessionIdOfServerMessage(ServerMessage message) => switch (message) {
      ...
      CaptureUploadAck(:final sessionId) => sessionId,
      CaptureUploadError(:final sessionId) => sessionId,
      _ => null,
    };
